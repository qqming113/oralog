...
/*******************************************************
  ...
  DESCRIPTION:      Main table. This is where magic happens. All jobs will
                    populate this table and user ill be able to retrieve details
                    from here
  INPUT PARAMS:     N/A
  OUTPUT PARAMS:    N/A
  COMMENTS:
...
--This index is not really needed, can be removed
